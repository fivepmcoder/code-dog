<template>
    <div class="flex h-dvh flex-col overflow-hidden">
        <!-- 导航栏 -->
        <nav class="top-0 z-50 container flex min-w-full shrink-0 items-center justify-between p-4">
